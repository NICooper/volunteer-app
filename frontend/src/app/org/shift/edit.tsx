...
// import { Activity, InsertActivity, InsertShift, Shift } from '@shared/db/schema-types';
...
//     mutationFn: (shift: InsertShift) => createOrUpdateShift(shift),
//     onSuccess: (savedShift: Shift) => {
...
//       setDescription(shift.description || undefined);
//     }
//   }
